...
export default function Header() {
  ...
  return (
    <div className="sticky top-3 z-50 px-3">
      <header className="relative z-50 mx-auto flex max-w-6xl items-center justify-between rounded-full border border-foreground/10 bg-background px-5 py-2.5 shadow-[var(--header-shadow)]">
