...
export function PointsIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path
        d="M12 3.5 14.5 9l6 .8-4.4 4 1.2 5.9L12 16.8 6.7 19.7l1.2-5.9-4.4-4 6-.8z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <rect
        ...
        strokeWidth="2"
      />
      <path d="M4 9h16v3.5H4z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      <path d="M12 9v11" stroke="currentColor" strokeWidth="2" />
      <path
        d="M12 9c0-2.5-1.5-4.5-3.5-4.5S6 6.2 6 7.7 7.2 9 8.5 9H12Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M12 9c0-2.5 1.5-4.5 3.5-4.5S18 6.2 18 7.7 16.8 9 15.5 9H12Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <rect
        ...
        strokeWidth="2"
      />
      <path d="M11 5.5h2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
