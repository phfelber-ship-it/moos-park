  ...
  return (
    <div>
      <section className="relative flex min-h-[75vh] items-end overflow-hidden text-center text-white sm:min-h-[90vh]">
        ...
        <div className="relative z-10 mx-auto flex max-w-2xl flex-col items-center px-6 pb-16">
          <Image
            src="/images/logo.png"
          ...
          <p className="mt-2 text-lg font-bold uppercase tracking-[0.3em] text-white/70">
            Pöttmes
          </p>
          ...
          <div className="mt-10 flex w-full max-w-xs flex-col gap-3">
            {MAIN_ACTIONS.map((action) => (
              <Link
                ...
                className={
                  action.filled
                    ? "w-full rounded-full bg-accent px-6 py-3.5 text-center text-sm font-black uppercase tracking-wide text-black transition-transform hover:scale-105"
                    : "w-full rounded-full border border-white/40 px-6 py-3.5 text-center text-sm font-black uppercase tracking-wide text-white transition-colors hover:border-white"
                }
              >
                {action.label}
              </Link>
