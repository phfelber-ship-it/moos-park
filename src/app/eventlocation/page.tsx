...
const ROOMS = [
  {
    ...
    image: "/images/rooms/main-halle.png",
  },
  {
    name: "Terrasse",
    ...
    image: "/images/rooms/terrasse.png",
  },
  {
    name: "Lounge",
  ...
  },
  {
    ...
    image: "/images/rooms/chillout.png",
  },
  {
    name: "Foyer",
  ...
  },
  {
    ...
    image: "/images/rooms/pizzeria.png",
  },
];
  ...
  return (
    <div>
      ...
      <section className="px-6 pb-24">
        <div className="mx-auto flex max-w-6xl flex-col gap-16">
          {ROOMS.map((room, i) => (
            ...
            >
              <div className="relative aspect-video w-full overflow-hidden rounded-2xl bg-white/5 lg:w-1/2">
                <Image
                  src={room.image}
                  alt={room.name}
                  fill
              ...
              <div className="w-full lg:w-1/2">
                ...
                <p className="mt-4 text-white/70">{room.text}</p>
                <a
                  href="#anfragen"
      ...
      <section id="anfragen" className="px-6 pb-28">
        <div className="mx-auto max-w-3xl rounded-3xl border border-white/5 bg-white/[0.03] p-8 sm:p-12">
          ...
          <form className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <select
              ...
              defaultValue=""
              className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white/80 outline-none focus:border-accent"
            >
            ...
            <textarea
              ...
              rows={4}
              className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-white/40 outline-none focus:border-accent sm:col-span-2"
            />
            <label className="flex items-start gap-2 text-xs text-white/50 sm:col-span-2">
